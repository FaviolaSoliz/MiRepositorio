...
weatherRequest.onload =  function () 
{
    ...
    document.getElementById('chill').innerHTML =weatherData.main.temp_min;
}
// ****** FORECAST ***
let forecastRequest = new XMLHttpRequest();
let apiURLforecast = 'https://api.openweathermap.org/data/2.5/forecast?id=3919966&units=metric&APPID=c2f1a30c08bf1465f982f10da498c31a'
